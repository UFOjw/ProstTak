...
Clone or download this repository to your Nginx web root directory.

Configure your Nginx server block. For example:
...
Open your browser and navigate to http://localhost:8080 to access the Anki Trainer.

Usage

Open index.html in your browser (or via local server).

Click Show Add Cards Form and paste your JSON card data.

Click Load Cards to start your session.

Use I Remember / I Don't Remember to record your answers.

Click Show Details to open the sidebar with additional card information.
